...
[![build windows](https://github.com/ddugovic/Stockfish/actions/workflows/build-windows.yml/badge.svg)](https://github.com/ddugovic/Stockfish/actions/workflows/build-windows.yml)
...
Improving Multi-Variant Stockfish requires a massive amount of testing. You can donate
your hardware resources by installing the [Multi Variant Fishtest Worker](https://github.com/ianfab/fishtest/wiki)
and view the current tests on [Multi Variant Fishtest](http://www.variantfishtest.org:6543/tests).
